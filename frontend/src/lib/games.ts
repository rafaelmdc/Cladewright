...
// A built-in fallback keeps the main game visible if the API is unreachable or the table
// is empty (fresh DB) — the game is never dark just because config hasn't loaded.
